...
//         {/* Profile Image */}
//         <div className="w-full max-w-[120px] sm:max-w-[150px] md:max-w-[200px] mx-auto">
//           <img
//             src={myImg}
//             alt="Profile"
...
//           {/* Heading */}
//           <h1 className="text-4xl md:text-7xl text-heading font-thin leading-tight">
//             I’m Ema <span className="text-primary font-medium"> Kelechi</span>
//           </h1>

//           {/* Subtitle */}
//           <h4 className="text-lg md:text-2xl text-paragraph">
...
//             <a
//               href="#work"
//               className="px-6 py-3 rounded-lg bg-primary text-white font-semibold shadow-md hover:bg-primary/80 transition text-center"
//             >
//               View my Work
//             </a>
//             <a
//               href="#contact"
//               className="px-6 py-3 rounded-lg border border-primary text-primary font-semibold hover:bg-primary hover:text-white transition text-center"
//             >
//               Get in Touch
//             </a>
//           </div>
      ...
      <div className="container text-white text-center flex flex-col justify-center items-center gap-2 mt-24">
        ...
        <div className="flex flex-col gap-2 justify-center items-center text-center max-w-3xl mx-auto">
          ...
          >
            <a
              href="#work"
              className="px-6 py-3 rounded-lg bg-primary text-white font-semibold shadow-md hover:bg-primary/80  transition-transform duration-300 hover:scale-105 text-center"
            >
              View my Work
            </a>
            <a
              href="#contact"
              className="px-6 py-3 rounded-lg border border-primary text-primary font-semibold hover:bg-primary hover:text-white  transition-transform duration-300 hover:scale-105 text-center"
            >
              Get in Touch
            </a>
          </motion.div>
